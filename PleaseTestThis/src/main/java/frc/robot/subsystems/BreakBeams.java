...
public class BreakBeams extends SubsystemBase {
  public DigitalInput HopperBeam;
  public DigitalInput MiddleBeam;
  public DigitalInput TopBeam;
  ...
  public boolean HopperBeamOutput(){
  ...
  public boolean MiddleBeamOutput(){
    boolean ballDetected;
