...
public class RunDoubleSolenoids extends CommandBase {
  ...
  SmartDashboard.putBoolean("climbsolenoid", RobotContainer.solenoidClimbButton.get());
    if(toggleClimb && RobotContainer.solenoidClimbButton.get()){
        toggleClimb = false;
      ...
      } else if(RobotContainer.solenoidClimbButton.get() == false){
        toggleClimb = true;
      }
 }
