...
public class OneLowOneHighAuton extends SequentialCommandGroup{
    public OneLowOneHighAuton(Intake intake, Drivetrain drivetrain, Conveyor conveyor, Solenoids solenoids, Shooter shooter, BreakBeams breakBeams, Limelights limelights){
