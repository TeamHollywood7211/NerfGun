...
public class RunClimbers extends CommandBase {
  ...
  public void execute() {
    ...
    if((RobotContainer.climbUp2Button.get() || RobotContainer.climbUp2ButtonOperator()) && (Climbers.ClimberL2Encoder.getPosition() < 580 || Climbers.ClimberR2Encoder.getPosition() < 580)){
