...
public class Shooter extends SubsystemBase {
    ...
    public Shooter() {
      ...
      //pid constants right
        ...
        //high around tarmac
          double HighkP = 0.0018;
          double HighkI = 0.0004;
          double HighkD = 0.00025;
        //high from safe wall
          double SafeWallRkP;
          double SafeWallRkI;
          double SafeWallRkD;
      ...
      shooterLeftPIDHigh = new PIDController(kP, kI, kD);
      shooterRightPIDHigh = new PIDController(kP, kI, kD);
