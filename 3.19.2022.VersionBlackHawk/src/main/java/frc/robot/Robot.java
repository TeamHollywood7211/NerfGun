...
public class Robot extends TimedRobot {
  ...
  public void autonomousInit() {
    DrivetrainCommand.frontTable.getEntry("pipeline").setNumber(1);
    DrivetrainCommand.frontTable.getEntry("camMode").setNumber(0);
  ...
  public void teleopInit() {
    ...
    DrivetrainCommand.frontTable.getEntry("camMode").setNumber(1);
    DrivetrainCommand.frontTable.getEntry("pipeline").setNumber(2);
