    ...
    public Shooter() {
      ...
      //right pid constants
        //slow right
          ...
          double SlowRkI = 0.000731; 
          double SlowRkD = 0.0002551;
        //high right
          double HighRkP = 0.004;
          double HighRkI = 0.0025;
          double HighRkD = 0.00025;
      //left pid constants
        //slow left
          double SlowLkP = 0.0033;
          double SlowLkI = 0.000731;
          double SlowLkD = 0.0002551;
        //high left
          double HighLkP = 0.004;
          double HighLkI = 0.00;
          double HighLkD = 0.000;
