...
//=============================Drivetrain Constants=======================================//   
    ...
    public static double powerRegulator = .9;
...
//=============================Shooter Constants=========================================//
    ...
    public static double shooterMotorPowerHigh = 0.18;
    public static int targetShooterVelocityHigh = 770;
    public static double shooterMotorPowerSlow = .12;
    public static int targetShooterVelocitySlow = 400;
//=============================BreakBeam Constants=======================================//
