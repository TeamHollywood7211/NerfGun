...
{    
    ...
    public MecanumDrivetrain(){
        frontLeft1 = new CANSparkMax(frontLeft1ID, MotorType.kBrushless);
        frontRight1 = new CANSparkMax(frontRight1ID, MotorType.kBrushless);
        backLeft1 = new CANSparkMax(backLeft1ID, MotorType.kBrushless);
        backRight1 = new CANSparkMax(backRight1ID, MotorType.kBrushless);
    ...
    //add ,ahrs.getAngle() to the end of mecDrive.driveCartesian(*) to make bot field oriented
